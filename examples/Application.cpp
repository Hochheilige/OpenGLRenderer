...
int main() {
	...
	std::unordered_map<std::string, std::string> texturePaths{
		{"container", "textures/container.jpg"},
		{"face", "textures/awesomeface.png"}
	};

	std::unordered_map<std::string, std::string> shadersPaths{
	...
	containerTexture.Load(texturePaths["container"], TextureFormat::RGB);
	Texture smileTexture;
	smileTexture.SetWrapType(TextureWrap::REPEAT);
	smileTexture.Load(texturePaths["face"], TextureFormat::RGBA);
	Shader shaders(shadersPaths["vertex"], shadersPaths["fragment"]);
